...
const HomeSection = () => {
  ...
  return (
    <section className="h-screen relative bg-[url('/img/nikah.jpg')]">
      <div className="absolute top-0 left-0 w-full h-full flex flex-col gap-4 justify-center items-center bg-gradient-to-t from-gray-300 to-gray-50/10 px-4">
